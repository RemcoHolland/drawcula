...
// number of moves available in a position (approximately)
...
private:
	...
	void knightMoves(const Board&, int);
	void bishopMoves(const Board&, int);
	void rookMoves(const Board&, int);
	void queenMoves(const Board&, int);
