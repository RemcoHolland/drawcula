...
//U64(0x0000002040810402) - H8 12 bit
//U64(0x0000102040800101) - A8 12 bit
//U64(0x0000102040008101) - B8 11 bit
//U64(0x0000081020004101) - C8 11 bit

//Adapted Grant Osborne's keys
//U64(0x0001FFFAABFAD1A2) - H8 11 bit
//U64(0x00FFFCDDFCED714A) - A8 11 bit
//U64(0x007FFCDDFCED714A) - B8 10 bit
//U64(0x003FFFCDFFD88096) - C8 10 bit
...
void initmagicmoves(void)
{
	...
	//for bitscans :
	//initmagicmoves_bitpos64_database[(x*U64(0x07EDD5E59A4E28C2))>>58]
