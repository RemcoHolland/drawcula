...
TEST(stalematepositions, stalemate_by_queen_sacrifice) {
	startSearch(FenReader::read("8/8/8/2p2p2/k1P2P1P/2Q2qP1/2K5/8 b - - 0 1"), 7);
	...
	EXPECT_THAT(output, testing::HasSubstr("info depth 6 score cp 0"));
	EXPECT_THAT(output, testing::HasSubstr("info depth 7 score cp 0"));
